    ...
    <div className='w-full bg-[#E8F1F5] px-[10px] md:px-[40px] lg:px-[121px] py-[30px] md:py-[82px] flex flex-col md:flex-row items-center justify-between space-y-8 md:space-y-0 gap-[16px] md:gap-[32px] lg:gap-[102px]'>
      <div className='flex-1'>
        <div className='flex justify-between items-center gap-[20px]'>
          <div className='flex-shrink-0 max-w-[113px] md:w-auto block sm:hidden'>
          ...
          <div>
            ...
            <p className='font-medium sm:font-semibold text-[#4C4A48] text-[16px] sm:text-[18px]'>
        ...
        <div className='flex flex-col gap-[10px] mt-[30px]'>
          <div className='flex flex-col md:flex-row gap-[10px]'>
            <input
              ...
              placeholder='Họ tên'
              aria-label='Họ tên'
              className='px-[12px] py-[11.5px] sm:px-[12px] sm:py-[14.5px] border border-[#E1DEDD] rounded-[10px] focus:outline-none focus:border-primary w-full max-w-full sm:max-w-[350px]'
            />
            <input
              type='tel'
      ...
      <div className='flex-shrink-0 w-full md:w-auto hidden sm:block'>
        <img src={ContactImage} alt='Contact' className='w-full h-auto max-w-full md:max-w-md' />
      </div>
    </div>
  )
