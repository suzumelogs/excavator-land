                ...
                <div className='p-[10px] md:p-4'>
                  ...
                  <div className='mt-[7px] md:mt-4'>
                    ...
                    <div className='flex flex-row justify-between mt-[7px] md:mt-4 gap-[10px]'>
                      ...
                      <button
                        onClick={parseInt(item?.EndDate) > 60 ? () => handleSubmit(item?.ProductUrl) : undefined}
                        className={`${parseInt(item?.EndDate) > 60 ? 'opacity-100 hover:opacity-80' : 'opacity-50'} md:h-[42px] w-full text-[12px] md:text-[14px] md:max-w-[202px] bg-[#FFA21A] text-[#121110] rounded-[4px] md:rounded-[10px] shadow-md transform focus:outline-none focus:ring-2 focus:ring-[#FFA21A] opacity-100 font-semibold  transition-opacity duration-300 mt-2 md:mt-0`}
                      >
                        Đặt hàng
                      </button>
                    </div>
